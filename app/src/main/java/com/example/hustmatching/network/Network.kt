...
object Network {
    ...
    suspend fun registerByJson(user: User) = userService.registerByJson(user).await()
    ...
    suspend fun publish(post: NetPostEx, token: String) = userService.publish(post, token).await()
